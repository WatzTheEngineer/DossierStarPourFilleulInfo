...
def classementJeu(nomjeu: str):
    """Affiche le classement du jeu sélectionné

    Args:
        nomjeu: Nom du jeu dont on affiche le classement
...
def menuScore(joueur1: Joueur, joueur2: Joueur):
    ...
    3. Retour
        ...
        match choix:
            case '1':
                mrPropre(), joueur1.afficherScore(), print(), joueur2.afficherScore(), print(), confirmRetour()
            case '2':
                printClassement()
            case '3':
                mrPropre()
