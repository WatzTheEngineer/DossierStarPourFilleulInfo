...
def ordiDifficile(mini: int, maxi: int) -> int:
    """Fonction qui permet à l'ordinateur de choisir un nombre entre mini et maxi

    Args:
        mini: borne inférieur
        maxi: borne supérieur
    Returns:
        Nombre choisi par le bot
    """
...
def tourOrdiDifficile(joueur: Joueur):
    """Procédure qui permet à l'ordinateur de jouer en mode difficile à Devinette

    Args:
        joueur: Joueur jouant contre l'ordi
    """
    ...
    while choix != 3:
        ...
        choix = saisieInt(joueur.pseudo + " faites votre choix : ", "Erreur de saisie")
